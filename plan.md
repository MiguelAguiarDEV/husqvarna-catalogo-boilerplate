...
Desktop (≥1024px): Render full slide layout
Mobile (<1024px): Use CSS transform: scale() + overflow: hidden + positioning to show only a portion of the slide
...
Calculate the current mobile viewport index based on activeSlide
Apply CSS transforms to show the appropriate section
Map mobile slide indices to desktop slide indices for navigation
Proposed Changes
Types & Interfaces
[NEW] 
slide.types.ts
